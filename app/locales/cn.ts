  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个AI角色`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "AI角色启动页",
        SubTitle: "新建聊天时，展示AI角色启动页",
      },
      Builtin: {
        Title: "隐藏内置AI角色",
        SubTitle: "在所有AI角色列表中隐藏内置AI角色",
      },
    },
    Prompt: {
      Disable: {
