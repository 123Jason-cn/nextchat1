...
import { useAppConfig, useChatStore, ModelType } from "../store";
...
export function SideBarHeader(props: {
  ...
  const { title, subTitle, logo, children, shouldNarrow, onShowSelect } = props;
  ...
  return (
    <Fragment>
      ...
      >
        <div className={styles["sidebar-title-container"]} onClick={handleClick}>
